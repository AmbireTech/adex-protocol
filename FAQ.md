...
We do not try to circumvent ad blockers, because we believe that users who intentionally use ad blockers are unlikely to convert anyway. However, in the long term, we believe that ad blockers will adopt more whitelisting [policies](https://acceptableads.com/) in order to be sustainable, and we are positioned to be a part of this by providing privacy-preserving, unobtrusive ads.
